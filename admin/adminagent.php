                        ...
                        <div class="md-card-content">
							<div id="userdiv">
								...
								<div class="md-input-wrapper">
									...
									<input type="hidden" class="md-input" value="agent" name="account_type" id="account_type">
									<span class="md-input-bar "></span>
								</div>
									...
									<table class="uk-table uk-table-striped" width="100%">
										...
										<tbody>
											<?php
												include ("../db.php");
												$n=0;
												$sql2 = $db->query("SELECT * FROM users u INNER JOIN useraccounttype ua WHERE u.id = ua.userId AND accName = 'agent' ORDER BY id DESC");
