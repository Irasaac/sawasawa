...
<?php // USER OPERATIONS
// 1 ADD NEW SALER
if(isset($_GET['salerUsername']))
{
	$salerName = $_GET['salerName'];
	$salerPhone = $_GET['salerPhone'];
	...
	while($row = mysqli_fetch_array($sql1))
	{
		echo'
			...
			<div class="md-input-wrapper">
				...
				<input type="text" class="md-input" name="Ename" id="Ename" value="'.$row['names'].'">
				<span class="md-input-bar "></span>
			</div>
			<div class="md-input-wrapper">
				<label>Phone</label>
				<input type="text" class="md-input" name="EPhone" id="EPhone" value="'.$row['phone'].'">
				<span class="md-input-bar "></span>
			</div>
			<div class="md-input-wrapper">
				<label>Email</label>
			...
			<div class="md-input-wrapper">
				...
				<input type="text" class="md-input" name="Eusername" id="Eusername" value="'.$row['loginId'].'">
				<span class="md-input-bar "></span>
			</div>
			<div class="md-input-wrapper">
