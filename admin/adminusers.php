                    ...
                    <div class="md-card">
                        ...
                        <div class="md-card-content">
							<div id="userdiv">
								...
								<button onclick="insertSaler()"  class="md-btn md-btn-success">Add</button>
							</div>
									...
									<table class="uk-table uk-table-striped" width="100%">
										...
										<tbody>
											<?php
												include ("../db.php");
												$n=0;
												$sql2 = $db->query("SELECT * FROM users u INNER JOIN useraccounttype ua WHERE u.id = ua.userId AND accName = 'Saler' ORDER BY id DESC");
...
function insertSaler()
{
	...
	$.ajax({
			...
			data : {
				...
				salerPassword : password,
				salerLocation : Location,
